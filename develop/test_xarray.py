...
#%%
signal_mean = td.Mean()(signal, manage_original='add')

signal_out = filt.Normalize()(signal)
...
res = sqi.SpectralPowerRatio(threshold=[0.5, 0.8], method = 'welch')(signal, manage_original='add')
